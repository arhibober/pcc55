                            ...
                            <?php if ( 'on' == $featured_img ) { ?>
                                <td>
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        printf( '<img src="%1$s" class="attachment-thumbnail wp-post-image" alt="%2$s" title="%2$s" style="width: 200px !important;"/>', apply_filters( 'wpuf_no_image', plugins_url( '/images/no-image.png', __FILE__ ) ), __( 'No Image', 'wpuf' ) );
                                    }
                                    ?>
                                </td>
                            <?php } ?>
