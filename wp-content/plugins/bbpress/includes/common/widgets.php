...
background-color: #295e9c;
	background-image: linear-gradient(to left, rgba(51,104,166,1), rgba(27,62,102,1) );
	color: #fff;
	transition: all 1s; 
...
background-color: #295e9c;
			...
			<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
				<fieldset>
					...
					<div class="bbp-username">
						Имя пользователя: <br/>
						<input type="text" name="log" value="<?php bbp_sanitize_val( 'user_login', 'text' ); ?>" size="20" id="user_login" tabindex="<?php bbp_tab_index(); ?>" style="border-radius: 3px !important;
	...
	border: 1px solid #ccc!important;"/>
					...
					<div class="bbp-password">
						Пароль: <br/>
						<input type="password" name="pwd" value="<?php bbp_sanitize_val( 'user_pass', 'password' ); ?>" size="20" id="user_pass" tabindex="<?php bbp_tab_index(); ?>"  style="border-radius: 3px !important;
	webkit-border-radius: 3px !important;
	moz-border-radius: 3x !important;
	border: 1px solid #ccc!important;"/>
					</div>
					...
					<div class="bbp-submit-wrapper" style="float: left !important;">

						<?php do_action( 'login_form' ); ?>

						<button type="submit" name="user-submit" id="user-submit" tabindex="<?php bbp_tab_index(); ?>" class="button submit user-submit" style="background-color: #428bca;
	border-radius: 3px;
	...
	-webkit-transition: all 1s;
	padding: 10px !important;border: 0px; font-weight: bold; text-align: left;"><?php _e( 'Log In', 'bbpress' ); ?></button>
					...
					<?php if ( !empty( $settings['register'] ) || !empty( $settings['lostpass'] ) ) : ?>
						...
						<div class="bbp-login-links">
							...
							<?php if ( !empty( $settings['register'] ) ) : ?>
								...
								<a href="http://localhost/pcc55/wp-login.php?action=register" title="<?php esc_attr_e( 'Register', 'bbpress' ); ?>" class="bbp-register-link"><?php _e( 'Register', 'bbpress' ); ?></a>
		...
		<?php else : ?>
			...
			<div class="bbp-logged-in">
				...
				<b><?php bbp_user_profile_link( bbp_get_current_user_id() ); ?></b><br/>
 ...
 global $user_ID;
 if ($user_ID == 1)
	echo "<a href='http://localhost/pcc55/dobavte-novyj-post/' style='position: relative; top: 10px !important;'>Добавить новый пост</a><br/>
	<a href='http://localhost/pcc55/edit-post/dobavte-novyj-post/?edit=".$post->ID."' style='position: relative; top: 10px !important;'>Отредактировать текущий пост</a><br/>
	<a href='http://localhost/pcc55/edit-post/dobavte-novyj-post/?remove=".$post->ID."' style='position: relative; top: 10px !important;'>Удалить текущий пост</a>";
 endif;
