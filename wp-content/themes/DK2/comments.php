...
<h3 id="comments-title">
	...
	if (get_comments_number() > 1) {
			printf(__('%1$s отзывов на <i>%2$s</i>', 'shprinkone'), number_format_i18n(get_comments_number()), get_the_title());
		} else {
			printf(__('Один отзыв на <i>%s</i>', 'shprinkone'), get_the_title());
		}
		?>
</h3>
...
?>
<p class="nocomments">
	<?php _e('Комментарии отключены.', 'shprinkone'); ?>
</p>
