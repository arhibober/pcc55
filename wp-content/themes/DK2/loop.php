...
?>
<div id="masonry" class="masonry clearfix row" style="position: relative; top: -40px;">
	<!-- Start the Loop. -->
	<?php 
				global $query_string;
query_posts($query_string . "&order by post_modified desc");
if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<?php else: ?>
		<?php if ($_GET ["get"] == "cat")
			echo "Пополнение раздела ожидается.";
			else
			echo shprinkone_get_no_result(); ?>
	<?php endif; ?>
</div>
