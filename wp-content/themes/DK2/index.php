...
?>
<?php get_header(); ?>
<?php set_post_thumbnail(778, 782); ?>
...
echo "<div class='container'>";
	echo "<div id='content'>
		<div class='row' style='position: relative !important; top: -50px !important;'>";
			...
			echo "<div class='".shprinkone_get_contentspan()."' style='position: relative; top: 9px;'>";
				get_template_part('loop');
}				?>
			</div>
			<?php echo "			<div class='alignleft'>".next_posts_link('&laquo; Предыдущие посты')."</div>
