 ...
 */
function the_post_thumbnail( $size = 'post-thumbnail', $attr = '' , $width1 = 0, $height1 = 0, $avatar = 0) {
	echo get_the_post_thumbnail( null, $size, $attr, $width1, $height1, $avatar );
}
 ...
 * @param string|array $attr Optional. Query string or array of attributes.
 */
function get_the_post_thumbnail( $post_id = null, $size = 'post-thumbnail', $attr = '', $width1 = 0, $height1 = 0, $avatar = 0 ) {
	$post_id = ( null === $post_id ) ? get_the_ID() : $post_id;
	...
	if ( $post_thumbnail_id ) {
		...
		$html = wp_get_attachment_image( $post_thumbnail_id, $size, false, $attr , $width1, $height1, $avatar);
