 ...
 */
function wp_get_attachment_image($attachment_id, $size = 'thumbnail', $icon = false, $attr = '', $width1 = 0, $height1 = 0, $avatar = 0 ) {
	...
	if ( $image ) {
		...
		if ($avatar > 0)
		{
			echo "<style>
				@media screen and (min-width: 1400px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 295 / 375 > $height)
					    echo "width: 375px !important;
							height: ".$height * 375 / $width."px !important;";
					else
						echo "height: 295px !important;
							width: ".$width * 295 / $height."px !important;";
						echo "}				
				}
				@media screen and (min-width: 979px) and (max-width: 1400px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 295 / 315 > $height)
					    echo "width: 315px !important;
							height: ".$height * 315 / $width."px !important;";
					else
						echo "height: 295px !important;
							width: ".$width * 295 / $height."px !important;";
						echo "}			
				...
				@media screen and (min-width: 500px) and (max-width: 979px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 255 / 295 > $height)
					    echo "width: 295px !important;
							height: ".$height * 295 / $width."px !important;";
					else
						echo "height: 255px !important;
							width: ".$width * 255 / $height."px !important;";
						echo "}			
				}
				@media screen and (min-width: 400px) and (max-width: 500px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 215 / 255 > $height)
					    echo "width: 255px !important;
							height: ".$height * 255 / $width."px !important;";
					else
						echo "height: 215px !important;
							width: ".$width * 215 / $height."px !important;";
						echo "}			
				}
				@media screen and (max-width: 400px)
				{
					#avatar".$avatar."
					{";					
					if ($width * 155 / 195 > $height)
					    echo "width: 195px !important;
							height: ".$height * 195 / $width."px !important;";
					else
						echo "height: 155px !important;
							width: ".$width * 155 / $height."px !important;";
						echo "}			
				}
				</style>";
		}
		...
		if (($width1 > 0) && ($height1 > 0) && ($avatar == 0))
		{
			$html .= 'style="';
			if ($width > $height)
			{
				$html .= "width: ".$width1."px;";
				$html .= "height: ".$height * $width1 / $width."px;";				
			}
			else
			{
				$html .= "width: ".$width * $height1 / $height."px;";
				$html .= "height: ".$height1."px;";				
			}
			$html .= '"';
		}
		if (($width1 > 0) && ($height1 == 0) && ($avatar == 0))
			$html .= 'style="width: '.$width1.'px; height: '.$height * $width1 / $width.'px;"';
		if (($width1 == 0) && ($height1 > 0) && ($avatar == 0))
			$html .= 'style="width: '.$width * $height1 / $height.'px; height: '.$height1.'px;"';
		$html .= ' />';
	}
