...
function wp_nav_menu( $args = array() ) {
	...
	$iv = '<ul id="%1$s" class="%2$s"';
	if (strstr($_SERVER['HTTP_USER_AGENT'], 'MSIE'))
		$iv .= " style='position: relative !important; top: 5px !important; left:-10px !important;'";
	$iv .= '>%3$s</ul>';
	$defaults = array( 'menu' => '', 'container' => 'div', 'container_class' => '', 'container_id' => '', 'menu_class' => 'menu', 'menu_id' => '',
	'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '', 'items_wrap' => $iv,
